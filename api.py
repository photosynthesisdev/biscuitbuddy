...
@app.post("/upload/")
def upload(audio_file: UploadFile, conversation_id: Optional[str] = Cookie(default=None)):
    def get_biscuit_response(audio_file_path):
        ...
        biscuit_response = biscuit_gemini.ask_biscuit(user_question)
    ...
    # save to the directory the wav file.
    file_location = f"./uploads/{conversation_id}_{int(time.time())}.wav"
